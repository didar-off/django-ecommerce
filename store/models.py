...
class Category(models.Model):
    ...
    icon = models.FileField(upload_to='category/icons', default='default-category.jpg', null=True, blank=True)
...
class Product(models.Model):
    ...
    vendor = models.ForeignKey(user_models.User, on_delete=models.CASCADE, related_name='products')
